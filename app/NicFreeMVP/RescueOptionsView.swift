            ...
            ZStack {
                ...
                ScrollView(showsIndicators: false) {
                    VStack(spacing: 18) {
                        ...
                        Text("Choose the kind of support that fits this moment. It does not have to be the same every time.")
                            .font(.footnote)
                            .foregroundStyle(Color.secondaryText)
                ...
                if isPrimary {
                    HStack(spacing: 8) {
                        Image(systemName: "sparkles")
                            .font(.caption.weight(.bold))
                        Text("A good place to start when the urge feels strong and you need one clear next step.")
